...
{
	static char *gpu[2] = {&Config.Gpu, NULL};
	static char *cdr[2] = {&Config.Cdr, NULL};
	static char *spu[2] = {&Config.Spu, NULL};
	static char *pad[3] = {&Config.Pad1, &Config.Pad2, NULL};
	static char *net[2] = {&Config.Net, NULL};
...
- (void)runCommand:(id)arg
{
    ...
    int which = [[arg objectAtIndex:1] intValue];
    long (*func)(void);
