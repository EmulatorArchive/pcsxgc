...
static long pad_buf1len,pad_buf2len;//shadow add
...
static long CardState = -1;
static TCB Thread[8];
static long CurThread = 0;
...
void psxBios_rand() { // 2f
	// FIXME: use a "known" random function, otherwise rand won't be seeded on a defreeze
